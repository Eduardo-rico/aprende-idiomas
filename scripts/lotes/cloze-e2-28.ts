...
export const ITEMS: Cloze[] = [
  ...
  { p: 'b1-tonica-paroxitona', pasada: 1, r: 'fácil',
    s: 'Este exercício é ___ de fazer, não te preocupes.', pista: 'fácil — llana terminada en -l, y por eso lleva tilde', ancla: 'não te preocupes' },
  { p: 'b1-tonica-paroxitona', pasada: 1, r: 'útil',
    s: 'Este dicionário é muito ___ para quem traduz.', pista: 'útil — llana terminada en -l, lleva tilde', ancla: 'para quem traduz' },
  { p: 'b1-tonica-paroxitona', pasada: 1, r: 'álbum',
    s: 'Trouxe o ___ de fotografias da viagem.', pista: 'álbum — llana terminada en -m, lleva tilde', ancla: 'de fotografias da viagem' },
  { p: 'b1-tonica-paroxitona', pasada: 1, r: 'táxi',
    s: 'Chamámos um ___ para ir ao aeroporto.', pista: 'taxi — llana terminada en -i, lleva tilde', ancla: 'para ir ao aeroporto' },
  ...
  { p: 'b1-acento-agudo', pasada: 1, r: 'país',
    s: 'Portugal é um ___ pequeno mas com muita costa.', pista: 'país — aquí el agudo no abre nada: rompe el diptongo', ancla: 'mas com muita costa' },
  ...
  { p: 'b1-acento-agudo', pasada: 1, r: 'água',
    s: 'Traz uma garrafa de ___ da cozinha, se faz favor.', pista: 'agua — el agudo marca la tónica sobre la «a»', ancla: 'da cozinha' },
  ...
  { p: 'b1-acento-circunflexo', pasada: 1, r: 'mês',
    s: 'O ___ de agosto foi o mais quente de sempre.', pista: 'mes — el circunflejo cierra la «e»', ancla: 'o mais quente de sempre' },
  { p: 'b1-acento-circunflexo', pasada: 1, r: 'três',
    s: 'Tenho ___ irmãos mais novos do que eu.', pista: 'tres — el circunflejo cierra la «e»', ancla: 'mais novos do que eu' },
  { p: 'b1-acento-circunflexo', pasada: 1, r: 'português',
    s: 'Estou a aprender ___ há quase dois anos.', pista: 'portugués — circunflejo en la última sílaba', ancla: 'há quase dois anos' },
