...
export const ITEMS: ItemMed[] = [
  ...
  },
  {
    ...
    marcadores: [['diz aos outros', 'Informa-se', 'Comunica-se', 'Dá-se conhecimento'], ['que me ligue', 'deverá contactar', 'queira contactar', 'contactar']],
    datos: [['água'], ['de manhã', 'da manhã', 'período da manhã']],
    modelo: 'AVISO — Informa-se que o abastecimento de água estará suspenso durante o período da manhã de amanhã. Solicita-se que se evite a chegada antecipada. Em caso de necessidade, deverá contactar-se o responsável.',
  ...
  },
  {
    ...
    marcadores: [['Malta', 'Comunica-se', 'Informa-se', 'Dá-se conhecimento'], ['avise-me', 'deverá comunicar-se', 'queiram comunicar', 'comunicar-se']],
  ...
  },
  {
    ...
    marcadores: [['diz-lhes', 'Informa-se', 'Comunica-se', 'Torna-se público'], ['não aceito mais nada', 'não serão aceites', 'não se aceitarão', 'não serão consideradas']],
  ...
  },
  {
    ...
    marcadores: [['Manda-lhes dizer', 'Comunica-se', 'Informa-se', 'Dá-se conhecimento'], ['que trate disso já', 'deverão regularizar', 'deverá proceder-se', 'regularizar']],
