...
export const ITEMS: ItemRo[] = [
  { p: COMPL, pasada: 1, espejoEs: false, atajoEs: false, transparenteLatin: false,
    ...
    explicacion: 'El sujeto «prietenii mei» no cabe entre «să» y el verbo: ahí sólo entran los clíticos, «nu» y los adverbios «mai, și, tot, prea, cam». Con el sujeto delante, la subordinada se abre con «ca»; la otra salida es posponerlo detrás del verbo.' },
  { p: COMPL, pasada: 1, espejoEs: false, atajoEs: false, transparenteLatin: false,
    ...
    explicacion: 'También con los impersonales. El español encadena «que» + sujeto + verbo y el rumano no puede: «să» va pegado al verbo, así que el sujeto sale fuera y aparece «ca» delante de él.' },
  { p: COMPL, pasada: 1, espejoEs: false, atajoEs: false, transparenteLatin: false,
    ...
    explicacion: 'Con los verbos de petición pasa lo mismo que con los de voluntad: «cere CA elevii SĂ citească». Lo que decide no es el verbo principal sino dónde queda el sujeto, y delante del verbo subordinado no cabe.' },
  { p: COMPL, pasada: 1, espejoEs: false, atajoEs: false, transparenteLatin: false,
    ...
    explicacion: 'El grupo «vecinii noștri» es el sujeto de «închidă» y por eso no puede quedarse entre la partícula y el verbo. Escrito con «ca» delante del sujeto, el orden del español se conserva entero.' },
  { p: COMPL, pasada: 1, espejoEs: false, atajoEs: false, transparenteLatin: false,
    ...
    explicacion: 'La partícula «să» y el verbo forman una unidad que nada rompe. Cuando el español mete el sujeto detrás de «que», el rumano lo saca delante y abre con «ca».' },
