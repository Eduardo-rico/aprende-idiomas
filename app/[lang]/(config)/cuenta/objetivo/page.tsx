// app/[lang]/(config)/cuenta/objetivo/page.tsx
...
// The semantic <main> wrapper is owned by app/[lang]/(config)/cuenta/
// layout.tsx; this page is a <div> with its own narrower max-width.
