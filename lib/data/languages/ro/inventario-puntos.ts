...
export const PUNTOS_RO: PuntoRo[] = [
  ...
  P({ id: 'r6-doblado-cliticos', nombre: 'Doblado obligatorio del clítico', bloque: 6, nivel: 'A2',
    ...
    motivo: '«veo a Ion» es español perfecto y *Văd pe Ion es su calco: corrección desde el calco. NO a juicio: la glosa contiene la respuesta. AVISO ESCRITO EL 2026-09-03, sin actuar sobre los 8 ítems publicados: la descripción dice «se dobla SIEMPRE» y eso vale para el objeto DIRECTO marcado con pe (GALR: con nombre propio de persona y con nombre común determinado, la duplicación es obligatoria; con plural escueto NO ESPECÍFICO no está exigida, y por eso el lote 16 dejó sólo dos plurales escuetos de ocho). Para el objeto INDIRECTO no vale: GALR II («Anticiparea și reluarea complementului indirect») hace el doblado obligatorio con pronombre fuerte (Mie ÎMI place) o con el OI antepuesto (Mariei ÎI dau cartea), y OPCIONAL con OI léxico pospuesto — «Dau cartea Mariei» es correcto. Los ocho ítems publicados son todos de objeto directo y no les afecta; lo que pide relectura es la formulación del punto. Y el otro flanco, medido: el español de México no dobla el OD léxico POSPUESTO («Vi a Juan»), que es de donde sale el calco, pero SÍ dobla obligatoriamente con el objeto ANTEPUESTO («A María la vi ayer») y con pronombre fuerte («Lo veo a él») — una glosa así se resolvería copiando el clítico del español, y el gate del lote 16 lo comprueba', cubre: ['A2/GRAMÁTICA · CLÍTICOS'],
