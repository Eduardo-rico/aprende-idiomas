...
export const PUNTOS_RU: PuntoRu[] = [
  ...
  P({ id: 'u6-adjetivo-declinado', nombre: 'El adjetivo concuerda en género, número Y CASO', bloque: 6, nivel: 'A1',
    ...
    motivo: 'deriva por regla y el gate lo recalcula. ⚠ AVISO ESCRITO ANTES DE QUE MUERDA, y es el §4.13bis rumano en su forma rusa: en la declinación dura el nominativo masculino es -ый/-ой y el neutro -ое, PERO el instrumental y el prepositivo de masculino y neutro COINCIDEN (-ым, -ом). Un ítem de concordancia de género escrito en instrumental aprueba sin distinguir el género. La clase con los dos plurales homógrafos del rumano tiene aquí su equivalente exacto: el plural adjetival es ÚNICO para los tres géneros en los seis casos. Un ítem de concordancia en plural no mide género JAMÁS',
  ...
  P({ id: 'u8-formacion-pares', nombre: 'Los tres mecanismos de formación del par, como sistema derivativo', bloque: 8, nivel: 'B1',
  ...
  P({ id: 'u13-familias-derivativas', nombre: 'Familias completas: учить → учитель, учебник, учёба, изучать, переучиться', bloque: 13, nivel: 'B2',
    ...
    gratis: 'el mecanismo. Lo que no es gratis, y es lo que el punto mide, es que cada miembro tenga RÉGIMEN PROPIO (учить кого чему frente a изучать что), que es donde el alumno derivará bien la palabra y la usará mal.',
  ...
  P({ id: 'u15-fraseologia-alusion', nombre: 'Фразеологизмы y крылатые выражения, incluido el cine soviético', bloque: 15, nivel: 'C1',
    ...
    capas: { examina: 'lexico', dadas: ['registro'] },
    gratis: 'el MECANISMO, y del español mexicano muy en concreto: citar cine y televisión en la conversación («¿Y ahora quién podrá defenderme?», Cantinflas, los refranes truncados) es una práctica idéntica. El alumno sabe cómo funciona un texto precedente. Lo que no tiene es el repertorio, y eso no se enseña con una lista.',
