// lib/data/languages/cs/curriculum.ts
// Phase 5 (multi-idioma): scaffold vacío para checo. No se genera contenido
...
export function getBlock(_id: number): Block {
  throw new Error("No blocks for cs yet (Phase 5 scaffold).");
}

export function getLesson(_id: LessonId): Lesson {
  throw new Error("No lessons for cs yet (Phase 5 scaffold).");
}
