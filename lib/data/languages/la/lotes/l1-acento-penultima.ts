...
//
// 1 · **El 61,5 % de las 1.429 formas de L1 son llanas.** Quien conteste
...
//     gate lo exige: por encima del 65 % de llanas, rojo.
//
// 2 · **La penúltima larga POR POSICIÓN es el 3,8 % de las formas
//     atestiguadas.** Es la única categoría que refuta mirar sólo el
//     mácrón, así que respetar su proporción daría 0,76 ítems de la mitad
...
// con diptongo en la penúltima**: cero de 1.429. No es un hueco del lote,
...
//
// El `motivo` de `l1-larga-por-posicion` dice que «el alumno que sólo mira
// el mácrón se equivoca en la mitad de las palabras». Medido sobre las
// formas atestiguadas de L1, **se equivoca en el 3,8 %**. Queda anotado
// para quien revise el inventario: no cambia este lote, pero la cifra del
// descriptor no sale del corpus del propio proyecto.
//
// ── LAS PALABRAS SON LAS QUE EL ALUMNO VA A LEER ─────────────────────
//
// Todas están atestiguadas y la mayoría son de altísima frecuencia:
// `dīxit` ×517, `Deus` ×271, `fīlius` ×162, `dominī` ×173. El acento de
