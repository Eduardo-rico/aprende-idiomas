...
export const PUNTOS_LA: PuntoLa[] = [
  ...
  P({ id: 'l1-larga-por-posicion', nombre: 'Larga por naturaleza y larga por posición', bloque: 1, peldano: 'L1',
    ...
    motivo: 'regla derivable. LA CIFRA QUE DECÍA ESTE MOTIVO ERA FALSA y se corrige el 2026-09-12 con la medida: quien sólo mira el mácrón falla en el 6,3 % de las formas atestiguadas de L1 (87 de 1.385) y en el 0,7 % de los tokens, no en la mitad. La confusión probable es con OTRO error, que sí es grande: el instinto castellano de acentuar siempre la penúltima falla en el 34,7 % de las formas y el 8,9 % de los tokens — y ése lo cubre `l1-acento-penultima`, no este punto. Lo que este punto enseña es raro y caro, no frecuente',
