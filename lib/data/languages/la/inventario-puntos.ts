...
export const PUNTOS_LA: PuntoLa[] = [
  ...
  P({ id: 'l4-demostrativos', nombre: 'hic, iste, ille: la deixis de tres grados', bloque: 4, peldano: 'L1',
    descripcion: 'Los tres grados coinciden con «este/ese/aquel» del español, que es de los pocos regalos deícticos que quedan en una lengua romance.',
    prereqs: ['l4-is-ea-id'], clase: 'paradigma',
    calco: { ordenEnganya: 'no', herencia: 'regalo', via: 'produccion' },
    motivo: 'transfiere; deriva por regla',
  ...
  P({ id: 'l5-pro-drop', nombre: 'El sujeto pronominal sólo aparece si es enfático', bloque: 5, peldano: 'L1',
    ...
    prereqs: ['l5-presente'], clase: 'lexico', formato: 'cloze-en-glosa',
